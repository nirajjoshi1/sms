    ...
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        <div className="relative mb-8 group">
          <div className="absolute inset-0 bg-indigo-500/20 rounded-3xl blur-2xl transition-all duration-500 group-hover:bg-indigo-500/30" />
          <img 
            src="/images/404.jpg" 
        ...
        <p className="text-gray-400 text-lg mb-10 max-w-md" style={{ fontFamily: "'Barlow', sans-serif" }}>
          The coordinates you entered don't match any known sectors. The page might have been moved, deleted, or perhaps never existed at all.
        </p>
